...
-------------
### Added
- **New icons:** ABAP, ActionScript, Alloy, ANTLR, API Blueprint, Arc, Arduino, ATS, Augeas, AutoHotkey, AutoIt, ColdFusion, Manual pages, Pascal
...
[Unreleased]: https://github.com/DanBrooker/file-icons/compare/v1.7.2...HEAD
