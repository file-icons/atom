...
---------------------
### Added
- **Support:** Eagle (`.eup`), Firebase (`.bolt`), KiCad (`.kicad_pcb-bak`, `.kicad_mod`, `.kicad_wks`, `fp-lib-table`), Moustache (`*.stache`), Printed Circuit Boards (`.pcb`, `.gbr`, `.gtl`, `.gbl`, `.gbs`, `.gto`, `.gts`, `.gtp`, `.gbo`, `.gbp`, `.drl`, `.dsn`), Text (`.dri`, `.gpi`, `.rpt`)
