...
- **Support:** Appcelerator Titanium (`.tss`), Checksum lists (`{.,}{check,ck,crc{,32},md5,rmd160,sha{1..3,224,384,512}}sum{,s}`), Database (`.tgn`), EditorConfig (`.ecrc`), Grammar (`.grammar`), Maps (`.mapping`, `.tiny`, `.tinyv2`, `.enigma`, `.match`, `.unpick`), PEG.js (`.peggy`), TextMate (`.tm_properties`, `.tmProperties`), XML (`.xmp`)
