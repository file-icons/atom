...
- **Support:** Appcelerator Titanium (`.tss`), EditorConfig (`.ecrc`), Grammar (`.grammar`), Maps (`.mapping`, `.tiny`, `.tinyv2`, `.enigma`, `.match`, `.unpick`), PEG.js (`.peggy`), TextMate (`.tm_properties`, `.tmProperties`), XML (`.xmp`)
