 ...
 *
 * TODO: This class shouldn't need to exist. We should be using a Chai
 * extension to handle the filtering and querying for us. Spec-specific
 * stuff really shouldn't be let out of its cage.
 *
 * @extends {Array}
 * @class
 */
