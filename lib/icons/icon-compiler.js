...
class IconCompiler{
	 ...
	 */
	recompile(){
		this.compileConfigFile(SOURCE_FILE, OUTPUT_FILE);
	}
	...
	/**
	 * Compile the CSON config's source into JavaScript source.
	 *
	 * @param {String} source - Blob of CSON data
	 * @return {String}
	 */
	compileConfigData(source){
