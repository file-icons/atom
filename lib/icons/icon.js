 ...
 */class Icon{/**
	 ...
	 * @constructor
	 */constructor(index,icon,colour,match,priority=1,matchPath=null,interpreter=null,scope=null,lang=null,sig=null){this.index=index,this.icon=icon,this.colour=colour,this.match=match,this.priority=priority,this.matchPath=matchPath||false,this.interpreter=interpreter||null,this.scope=scope||null,this.lang=lang||null,this.signature=sig||null}/**
	 * Return the CSS classes for displaying the icon.
	 *
	 * @param {Number|null} colourMode
	 * @param {Boolean} asArray
	 * @return {String}
	 */getClass(colourMode=null,asArray=false){// No colour needed or available
return null===colourMode||null===this.colour[0]?asArray?[this.icon]:this.icon:asArray?[this.icon,this.colour[colourMode]]:this.icon+" "+this.colour[colourMode]}}module.exports=Icon;