...
["js-icon",["medium-yellow","dark-yellow"],/\.js$|\.es\d?$|\.snap$/i,,false,/^(?:node|chakra|d8|iojs|g?js|qjs(?:c?|bnc?)?|mujs|rhino|slimerjs|v8(?:-shell)?)$/,/\.js$/i,/^Java[\W_ \t]?Script$|^(?:js|node)$/i],
