...
["emacs-icon",["medium-purple","medium-purple"],/(?:^|\.)(?:el|_?emacs|spacemacs|emacs\.desktop|abbrev[-_]defs)$/i,1.5,false,/^emacs$/,/\.emacs\.lisp$/i,/^Emacs Lisp$|^elisp$/i],
...
["octave-icon",["medium-orange","medium-orange"],/\.octave$/i,,false,,/\.octave$/i,/^Octave$/i],
...
["textmate-icon",["medium-green","medium-green"],/\.tmcg$/i,,false,,/\.tmcg$/i,/^TextMate$/i],
