...
const {FileSystem, normalisePath} = require("atom-fs");
const Options = require("../options.js");
const Storage = require("../storage.js");
const UI      = require("../ui.js");

const COMPILER_PATH = join(__dirname, "..", "..", "bin", "compile");
...
class AutoCompiler{
	...
	recompile(){
		...
		const source = join(__dirname, "..", "..", "config.cson");
		const target = join(__dirname, ".icondb.js");
	...
	describeError(code, signal){
		...
		console.error(`AutoCompiler::Error - ${message}`, {
